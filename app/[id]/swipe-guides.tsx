...
const SwipeGuides = () => {
  return (
    <div className="absolute bottom-0 left-0 right-0 top-0 z-10 flex justify-evenly gap-0 text-4xl text-white">
      ...
      <div className="relative h-full w-full bg-gradient-to-r from-transparent to-blue-500 to-80% p-5 text-right">
        <p>Pass</p>
